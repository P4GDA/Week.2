...
Write an if statement to check if mouse 1 is female and if so, prints "Mouse is female". Do not alter the line containing the code `q.1.a <-` or otter grader will not be able to check your answer.
```{r}
q.1.a <-
...
Write the statement WITHOUT using a logical expression containing `&`, and WITHOUT USING the comparison operators `>` and `>=` in your code (`>` and `>=` can appear in your print statements). Do not alter the line containing the code `q.2.a <-` or the otter grader will not be able to check your answer.
```{r}
q.2.a <-
# Write and execute your code here
...
Do not alter the line containing the code `q.3.b <-` or otter grader will not be able to check your answer.
```{r}
q.3.b <-
# Write and execute your code here
