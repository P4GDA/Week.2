...
- If the absolute value of the difference is > 1 standard deviation away from the group mean, the value `TRUE` is assigned to a variable named "over_1_sd", otherwise the value `FALSE` is assigned to a variable named "over_1_sd".
